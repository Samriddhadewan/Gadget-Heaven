...
const Cart = () => {
  ...
  return (
    <div>
        <div className="flex items-center my-5 justify-between">
            ...
            <button className="text-[#9538E2] flex gap-3 rounded-full border border-[#9538E2] px-3 py-3">Sort By Price <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
  <g clip-path="url(#clip0_13_2554)">
    ...
    <path d="M10 16C10 16.5304 10.2107 17.0391 10.5858 17.4142C10.9609 17.7893 11.4696 18 12 18C12.5304 18 13.0391 17.7893 13.4142 17.4142C13.7893 17.0391 14 16.5304 14 16C14 15.4696 13.7893 14.9609 13.4142 14.5858C13.0391 14.2107 12.5304 14 12 14C11.4696 14 10.9609 14.2107 10.5858 14.5858C10.2107 14.9609 10 15.4696 10 16Z" stroke="#8332C5" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
  ...
  <defs>
    <clipPath id="clip0_13_2554">
      <rect width="24" height="24" fill="white"/>
            ...
            <button className="text-white rounded-full px-5 py-3 bg-[#9538E2]">Purchase</button>
            </div>
        </div>
